...
var cedulajd = button.data('cedulajd') 
var nombrejd = button.data('nombrejd') 
var rango = button.data('rango') 
var id = button.data('id') 
var modal = $(this)
modal.find('.modal-body #mod_nombre').val(nombre)
modal.find('.modal-body #cedulajd').val(cedulajd) 
modal.find('.modal-body #nombrejd').val(nombrejd) 
modal.find('.modal-body #rango').val(rango) 
